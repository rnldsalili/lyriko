...
export default [
  layout('layouts/main-layout.tsx', [
    ...
    route('artists', 'routes/artists.list.tsx'),
    route('artists/create', 'routes/artists.create.tsx'),
    route('artists/:slug/edit', 'routes/artists.edit.tsx'),
    route('artists/:slug', 'routes/artists.detail.tsx'),
    ...
    route('songs', 'routes/songs.list.tsx'),
    route('songs/create', 'routes/songs.create.tsx'),
    route('songs/:slug/edit', 'routes/songs.edit.tsx'),
    route('songs/:slug', 'routes/songs.detail.tsx'),
